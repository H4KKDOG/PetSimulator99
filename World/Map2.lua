return {
    ...
    Minigames = {
        {
            Name = "HoverboardTechObby",
            IsLoopable = false,
            HasCompletion = true,
            CustomFunction = nil
        },
        {
            Name = "DiamondWheelInstance",
            IsLoopable = false,
            HasCompletion = false,
            CustomFunction = nil
        }
